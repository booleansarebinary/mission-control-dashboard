...
ITERATIVE_METRICS = ['size', 'weight']
TELEMETRY_FILE = '/Users/anns/Documents/Mission Control Dashboard/Practice/practicefile.ndjson'
THRESHOLDS_FILE = '/Users/anns/Documents/Mission Control Dashboard/Practice/practicethresholds.json'
ERROR_LOG_FILE = '/Users/anns/Documents/Mission Control Dashboard/Practice/practiceerrorlog.txt'
    ...
    with open(TELEMETRY_FILE, 'r') as f, open(ERROR_LOG_FILE, 'a') as log_file:
        ...
        while True:
            ...
            for input in ITERATIVE_METRICS:
                ...
                print(f"{input.capitalize()}: {value}")
